let questions = [{
  "question": "Companies that continue to operate even though they’re bankrupt are called ?",
...
{
  "question": "What is the highest $ value of currency ever issued by the U.S. government?",
...
},
{
  ...
  "correctAnswer": "Getting a penny that’s doubled every day for a 31-day month.",
},
];
...
results.innerHTML = "<h2>You've finished the Trivia Game!</h2>" + "<h2>These are your results:</h2>" +
  ...
  "</h2>" + "<br>" + "<button onclick='reset()'>Player 2's Turn</button>";
}

function finalResults() {
// hide countdown when game ends
document.getElementById('timer').hidden = true
content.innerHTML = "Player 1:" + playerOneScore + "<br> Player 2:" + score +
"<br>Player " + (playerOneScore > score ? "1" : "2") + " wins!";
}
